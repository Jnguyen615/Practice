...
// const Modal = ({ closeModal, selectedMountId, mounts, favoriteMounts, toggleFavoriteMount,setFavoriteMount }) => {
...
//           <FavoriteIcon
//             id={selectedMountId}
//             isFavorite={favoriteMounts.some(favMount => favMount.id === selectedMountId)}
